...
public class TextUtil
{
    ...
    private static final MutableComponent PLUGIN_PREFIX = Component.literal(Util.formattedString(CobblemonKitsForge.languageConfig.prefix)).setStyle(Style.EMPTY.withColor(BLUE));

    private static final MutableComponent MESSAGE_PREFIX = getPluginPrefix().append(Component.literal(CobblemonKitsForge.languageConfig.splitter).setStyle(Style.EMPTY.withColor(ORANGE)));

    /**
     * @return a copy of the coloured Kits TextComponent
     */
    ...
    /**
     * @return a copy of the coloured Kits prefix
     */
